...
import (
	...
	resourceService "github.com/go-sso-example/auth-service/internal/service/resource"
	"github.com/go-sso-example/auth-service/internal/service/route"
	serviceService "github.com/go-sso-example/auth-service/internal/service/service"
	userService "github.com/go-sso-example/auth-service/internal/service/user"
	"github.com/go-sso-example/auth-service/internal/transport"
	pkgAuth "github.com/go-sso-example/auth-service/internal/transport/auth"
	...
	resourceRefresh "github.com/go-sso-example/auth-service/internal/worker/resource-refresh"
)
...
func (a *App) initWorker(_ context.Context) error {
	a.refreshResourceTicker = resourceRefresh.NewTicker(a.routeService, a.cfg.RefreshCacheRoutesWorkerMode)
	return nil
}
